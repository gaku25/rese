...
@section('content')
    ...
    <div class="mypage_favorite">
        ...
        <div class="card__img">
        <img src="../../public/storage/IMG_3152.JPG" alt="イメージ写真" />
        </div>
        ...
        <p class="card__tag">#テスト</p>
        <p class="card__date">#テスト</p>
        </div>
        ...
        <form action="" method="">
        <button class="card__cat" name="" value="">詳しく見る</button>
        <a href="">
        <img id="" class="" src="" alt="いいね" style=""/>
        </a>
        </form>
        </div>
    </div>
